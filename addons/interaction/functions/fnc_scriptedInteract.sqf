...
private _interactionConfig = [_vehicle, _configPath] call hct_interaction_fnc_loadItem;

if (isNil "_animationTargetLabel") exitWith {
 [_vehicle, _interactionConfig, true] call hct_interaction_fnc_buttonDown;
 [_vehicle, _interactionConfig, true] call hct_interaction_fnc_buttonUp;
};

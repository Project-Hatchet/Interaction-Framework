...
if (inputAction "defaultAction" > 0 && !hct_interaction_cursor_mouseDown) then {
	if (!isNil "hct_interaction_currentButton") then {
		// systemChat "CLICKING";
		[vehicle hct_player, hct_interaction_currentButton] call hct_interaction_fnc_buttonDown;
...
if (inputAction "defaultAction" == 0 && hct_interaction_cursor_mouseDown) then {
	if (!isNil "hct_interaction_currentButton") then {
		...
		[vehicle hct_player, hct_interaction_currentButton] call hct_interaction_fnc_buttonUp;

...
if (_animation != "") then {
  ...
  if(abs (abs hct_interaction_dragging_lastDragDistance - abs _verticalDistance) > 0.02) then {
    if (hct_interaction_showDebugMessages) then {systemChat str _verticalDistance;};
...
if (_animationH != "") then {
  ...
  if(abs (abs hct_interaction_dragging_lastDragDistanceH - abs _horizontalDistance) > 0.02) then {
    if (hct_interaction_showDebugMessages) then {systemChat str _horizontalDistance;};
